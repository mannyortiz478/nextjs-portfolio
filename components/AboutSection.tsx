      ...
      <div className="my-12 pb-12 md:pt-16 md:pb-48">
        ...
        <div className="flex flex-col space-y-10 items-stretch justify-center align-top md:space-x-10 md:space-y-0 md:p-4 md:flex-row md:text-left">
          <div className="md:w-1/2 ">
            <h1 className="text-center text-2xl text-sky-500 font-bold mb-6 md:text-left">
              Get to know me!
            </h1>
            <p className="text-lg">
              ...
              <span className="font-bold text-sky-400 ">{" adaptable"}</span> student
              based in PA.
            </p>
            <br />
            <p className="text-lg">
          ...
          <div className="text-center md:w-1/2 md:text-left">
            <h1 className="text-2xl text-sky-500 font-bold mb-6">My Skills</h1>
